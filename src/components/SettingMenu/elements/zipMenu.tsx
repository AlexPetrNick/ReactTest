...
export const ZipMenu: FC<initType> = (props) => {
    ...
    const onClickReset = (e:MouseEvent<HTMLButtonElement>) => {
        setStateObject(props.fieldsMenu)
    }

    const onClickSave = (e:MouseEvent<HTMLButtonElement>) => {
        dispatchAC(updateUserThunk(stateObject))
